...
public:
	...
	unsigned short getWeaponId();
	unsigned short getWeaponId() const;
	Item* getWeapon();
	Item* getWeapon() const;
	int setWeaponIfNull(Item*);
	int setWeapon(Item*);
	std::vector<unsigned short> getArtifactIds();
	std::vector<unsigned short> getArtifactIds() const;
	std::vector<Item*> getArtifacts();
	std::vector<Item*> getArtifacts() const;
	unsigned short getArtifactId(unsigned int);
	...
	int setArtifactIfNull(Item*);
	int setArtifact(Item*);
	int setArtifactIfNull(Item*, unsigned int);
...
private:
	...
	int set_equips;
	void loadEquips();
	std::vector<unsigned long long> equip_guids;
	unsigned int level;
	unsigned int exp;
