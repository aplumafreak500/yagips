...
public:
	...
	const Item* getItemById(unsigned int) const;
	Item* getItemById(unsigned int);
	const Item* getItemByGuid(unsigned long long) const;
	Item* getItemByGuid(unsigned long long);
	int setItem(unsigned long long, Item&);
	int setItem(unsigned long long, const Item&);
	int updateItem(const Item&);
	int addItem(Item*);
