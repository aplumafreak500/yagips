...
if (isset($_SERVER["HTTP_X_RPC_DEVICE_ID"])) {
	$post["device_id"] = $_SERVER["HTTP_X_RPC_DEVICE_ID"];
}
$ctx = stream_context_create([
	"http" => [
		...
		"content" => json_encode($post, JSON_NUMERIC_CHECK),
		"ignore_errors" => true
	]
]);
// TODO Make this configurable
$str = @fopen("http://127.0.0.1:22100/binder/verify", "rb", false, $ctx);
if ($str === false) {
...
// TODO: Replace country and area_code values in the data we get back from the server
print($rsp);
?>
